...
namespace Talentree.Repository.Data.Migrations
{
    ...
    [Migration("20260717185603_AddAdminNotesToMaterialOrder")]
    partial class AddAdminNotesToMaterialOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Talentree.Core.Entities.AiImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AiImages", (string)null);
                });

            modelBuilder.Entity("Talentree.Core.Entities.AiMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.AiSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.ArticleBookmark", b =>
                {
                    ...
                    b.ToTable("ArticleBookmarks", (string)null);
                });

            modelBuilder.Entity("Talentree.Core.Entities.AutoBlockLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AutoBlockLogs", (string)null);
                });
            ...
            modelBuilder.Entity("Talentree.Core.Entities.Complaint", b =>
                {
                    ...
                    b.HasIndex("CreatedBy", "CreatedAt")
                        .HasDatabaseName("IX_Complaint_CreatedBy_CreatedAt");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.CustomerCart", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_CustomerCart_CreatedAt");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.CustomerWishlist", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_CustomerWishlist_CreatedAt");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.Identity.BusinessOwnerPaymentInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("LastChangedByIp")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("BusinessOwnerPaymentInfos", (string)null);
                });
            ...
            modelBuilder.Entity("Talentree.Core.Entities.Identity.LoginHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.Identity.OnboardingProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ChecklistPaymentSet")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("ChecklistProductAdded")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("ChecklistProfileDone")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Talentree.Core.Entities.KnowledgeArticle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.NotificationPreference", b =>
                {
                    ...
                    b.Property<bool>("ReceiveAccountNotifications")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("ReceiveAutoBlockNotifications")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("ReceiveComplaintNotifications")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
                    ...
                    b.Property<bool>("ReceivePaymentNotifications")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("ReceivePayoutNotifications")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
                    ...
                    b.Property<bool>("ReceiveProductionNotifications")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
                    ...
                    b.Property<bool>("ReceiveReviewNotifications")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("ReceiveSupportNotifications")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("Talentree.Core.Entities.OrderStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.ProductReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.RefundRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BoNotes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BoResponse")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.SupplierReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.UserInteraction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talentree.Core.Entities.AiImage", b =>
                {
                    b.HasOne("Talentree.Core.Entities.AiMessage", "Message")
            ...
            modelBuilder.Entity("Talentree.Core.Entities.AiMessage", b =>
                {
                    b.HasOne("Talentree.Core.Entities.AiSession", "Session")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Talentree.Core.Entities.ArticleBookmark", b =>
                {
                    b.HasOne("Talentree.Core.Entities.KnowledgeArticle", "Article")
                        .WithMany("Bookmarks")
            ...
            modelBuilder.Entity("Talentree.Core.Entities.Complaint", b =>
                {
                    b.HasOne("AppUser", "ReportedBy")
                        .WithMany()
                        .HasForeignKey("ReportedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AppUser", "ReportedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Talentree.Core.Entities.CustomerCartItem", b =>
                {
                    b.HasOne("Talentree.Core.Entities.CustomerCart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Talentree.Core.Entities.CustomerOrderItem", b =>
                {
                    b.HasOne("Talentree.Core.Entities.CustomerOrder", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Talentree.Core.Entities.CustomerWishlistItem", b =>
                {
                    ...
                    b.HasOne("Talentree.Core.Entities.CustomerWishlist", "Wishlist")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Talentree.Core.Entities.Identity.BusinessOwnerPaymentInfo", b =>
                {
                    b.HasOne("AppUser", "User")
                        .WithOne("PaymentInfo")
                        .HasForeignKey("Talentree.Core.Entities.Identity.BusinessOwnerPaymentInfo", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Talentree.Core.Entities.Identity.UserPreferences", b =>
                {
                    b.HasOne("AppUser", "User")
                        .WithOne("Preferences")
                        .HasForeignKey("Talentree.Core.Entities.Identity.UserPreferences", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Talentree.Core.Entities.RefundRequest", b =>
                {
                    ...
                    b.HasOne("Talentree.Core.Entities.CustomerOrderItem", "OrderItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Talentree.Core.Entities.ReviewPhoto", b =>
                {
                    b.HasOne("Talentree.Core.Entities.ProductReview", "Review")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("Talentree.Core.Entities.SupplierReview", b =>
                {
                    ...
                    b.HasOne("Talentree.Core.Entities.MaterialOrder", "MaterialOrder")
                        .WithMany()
                        .HasForeignKey("MaterialOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Talentree.Core.Entities.SupportTicket", b =>
                {
                    ...
                    b.HasOne("Talentree.Core.Entities.Supplier", "RelatedSupplier")
            ...
            modelBuilder.Entity("Talentree.Core.Entities.RawMaterial", b =>
                {
                    b.Navigation("MaterialOrderItems");
                });
