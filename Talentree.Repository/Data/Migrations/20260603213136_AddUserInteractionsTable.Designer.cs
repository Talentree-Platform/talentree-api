...
namespace Talentree.Repository.Data.Migrations
{
    ...
    [Migration("20260603213136_AddUserInteractionsTable")]
    partial class AddUserInteractionsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Talentree.Core.Entities.MaterialOrderItem", b =>
                {
                    ...
                    b.HasOne("Talentree.Core.Entities.RawMaterial", null)
                        .WithMany("MaterialOrderItems")
                        .HasForeignKey("RawMaterialId1");
