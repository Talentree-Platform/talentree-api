...
{
    /// <inheritdoc />
    public partial class AddCustomerCartOrdersWishlist : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerWishlistItems_CustomerWishlists_WishlistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerCart_CreatedAt",
                table: "CustomerCarts",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerCart_CreatedBy_CreatedAt",
                table: "CustomerCarts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerOrder_CreatedBy_CreatedAt",
                table: "CustomerOrders",
                columns: new[] { "CreatedBy", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerWishlistItems_WishlistId_ProductId",
                table: "CustomerWishlistItems",
                columns: new[] { "WishlistId", "ProductId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CustomerWishlist_CreatedAt",
                table: "CustomerWishlists",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerWishlist_CreatedBy_CreatedAt",
                table: "CustomerWishlists",
                columns: new[] { "CreatedBy", "CreatedAt" });
