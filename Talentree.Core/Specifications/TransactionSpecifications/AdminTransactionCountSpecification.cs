...
{
    public class AdminTransactionCountSpecification : BaseSpecifications<Transaction>
    {
        public AdminTransactionCountSpecification(string? boId, TransactionType? type, DateTime? dateFrom, DateTime? dateTo, bool anomalyFlaggedOnly, string? search)
            : base(x => 
